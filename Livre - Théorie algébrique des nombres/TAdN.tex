...
\pagebreak
    ...
    Un module sera dit \emph{de type fini}\index{module!de type fini}\index{type fini (module de)} s'il admet un système générateur fini. \nameCref{thm:nœthérien} suivant est à la base de l'étude des anneaux et modules nœthériens, que nous développerons un peu plus au chapitre \labelcref{chap:anneaux nœthériens;anneaux de Dedekind}.
